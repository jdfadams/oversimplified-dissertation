...
\only<1>{
Why study the Mandelbrot set?
\begin{itemize}
    \item Dynamical systems are things that change over time.
    \item Complex dynamical systems are fundamental to mathematics.
    \item If we understand the Mandelbrot set, then we understand the dynamics of all quadratics.
    \item The Mandelbrot set is universal: $M$ is dense in the bifurcation locus of any holomorphic family of rational maps.
\end{itemize}
In this field, the most famous conjecture is called MLC: The Mandelbrot set is locally connected. }
\only<2>{
\centering
